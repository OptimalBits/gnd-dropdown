...
var DropDown = (function (_super) {
    ...
    function DropDown(collection, opts) {
        var _this = this;
        _super.call(this, {
        ...
        var selectOptions = this.selectOptions = new Gnd.Collection(SelectOption, { nosync: true });

        selectOptions.link(collection, function (evt, item, fields) {
            switch (evt) {
                case 'added:':
        ...
        selectOptions.on('added:', function (item) {
            if (_this.selectingId) {
                if (item.get('itemId') === _this.selectingId) {
                    _this.selectItem(item);
                }
            } else if (!_this.get('selectedItem')) {
                _this.selectItem(item);
            }
        });

        selectOptions.on('removed:', function (item) {
            if (item === _this.selectedItem) {
                _this.selectItem(selectOptions['first']());
            }
        });
    ...
    DropDown.prototype.render = function (context) {
        var _this = this;
        context = _.extend({
        ...
        return _super.prototype.render.call(this, context).then(function (el) {
            _this.viewModel = new Gnd.ViewModel(el, {
                collection: _this.selectOptions,
                combobox: _this
            }, { escape: _.escape });

            Gnd.$('.gnd-combobox-selected', el).on('click', function () {
                _this.activate(el);
            });

            Gnd.$(el).on('blur', function () {
                _this.deactivate(el);
            });
    ...
    DropDown.prototype.activate = function (el) {
        Gnd.$('.gnd-combobox', this.root).addClass('gnd-active').trigger('focus');
    };

    DropDown.prototype.deactivate = function (el) {
    ...
    DropDown.prototype.selectHandler = function (el) {
        var item = el['gnd-obj'];
        if (!item.disabled) {
    ...
    DropDown.prototype.selectById = function (id) {
